...
logger = logging.getLogger("gemeaspy_tests_emulator")
...
def initialize_logger():
    ...
    log_dir = os.path.normpath(f"{os.path.dirname(gemeaspy.__file__)}/../log/emulator")
    file_path = f"{log_dir}/emulator{now}.log"
